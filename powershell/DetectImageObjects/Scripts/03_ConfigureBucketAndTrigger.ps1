...
.Example
    .\03_ConfigureBucketAndTrigger.ps1 -BucketName "mybucket" -FunctionName "MyFunction"
.Example
    .\03_ConfigureBucketAndTrigger.ps1 -BucketName "mybucket" -FunctionName "MyFunction" -Region ap-southeast-1
#>
